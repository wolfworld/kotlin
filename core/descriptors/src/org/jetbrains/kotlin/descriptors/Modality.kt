...
val CallableMemberDescriptor.isOverridable: Boolean
    get() = isOverridableDespiteContainer && (containingDeclaration as? ClassDescriptor)?.isFinalClass != true

val CallableMemberDescriptor.isOverridableDespiteContainer: Boolean
